...
//printf("got result by probing inner hash table\n");	
    ...
    /*
     * If this is the first call, build the hash table for the inner relation
     */
   // if (hashtable == NULL)
    //{
        /*
         * Try to fetch an outer tuple early if beneficial
         */
        ...
        /*
         * Build hash table (executes Hash node)
         */
        /*hashNode->hashtable = hashtable;
        (void) MultiExecProcNode((PlanState *) hashNode);

        /*
         * If inner table empty → return NULL for non-left joins
         */
    ...
    /*
     * Original hash join process
     */
    /*for (;;)
    {
        /*
         * If we need a new outer tuple, fetch it
         */
        /*if (node->hj_NeedNewOuter)
        {
            ...
            /*
             * Find bucket for this outer tuple
             */
        ...
        *///}
        ...
        /*for (;;)
        {
            ...
            /*if (joinqual == NIL || ExecQual(joinqual, econtext, false))
            {
                ...
                /*
                 * For JOIN_IN, stop if match was found
                 */
                /*if (node->js.jointype == JOIN_IN)
                {
                    node->hj_NeedNewOuter = true;
       ...
       /* node->hj_NeedNewOuter = true;
        ...
        /*
         * LEFT JOIN: return NULL-extended tuple if no match
         */
        /*if (!node->hj_MatchedOuter &&
            node->js.jointype == JOIN_LEFT)
        {
